...
st.write("# Guess this Bollywood movie...")
...
if 'win' in st.session_state and not st.session_state.win and not st.session_state.lose:
    ...
    link = f"http://www.omdbapi.com/?t={st.session_state.movie['title'].strip().replace(' ', '_')}&y={st.session_state.movie['releaseYear']}&plot=short&apikey={os.environ.get('API_KEY')}"
